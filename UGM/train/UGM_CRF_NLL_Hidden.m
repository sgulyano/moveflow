function [NLL,g] = UGM_CRF_NLL_Hidden(w,Xnode,Xedge,Y,nodeMap,edgeMap,edgeStruct,inferFunc,varargin)
...
for i = 1:nInstances
    ...
    if any(Y(i,:)==0)
        ...
        [nodeBelC,edgeBelC,logZC] = UGM_Infer_Conditional(nodePot,edgePot,edgeStruct,Y(i,:),inferFunc,varargin{:});
