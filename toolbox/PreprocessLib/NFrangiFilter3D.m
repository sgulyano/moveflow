function [Iout,whatScale,LambdaOut1,LambdaOut2,LambdaOut3,Voutx,Vouty,Voutz,Voutx2,Vouty2,Voutz2,Voutx3,Vouty3,Voutz3]=NFrangiFilter3D(I,options,type)
%
...
for i = 1:length(sigmas),
    ...
    elseif nargout>8
        [Lambda1,Lambda2,Lambda3,Vx,Vy,Vz,Vx2,Vy2,Vz2,Vx3,Vy3,Vz3]=eig3volumeAllVec(Dxx,Dxy,Dxz,Dyy,Dyz,Dzz);
    else
    ...
    elseif type == 's'
        ...
        warning('FrangiFilter3D:unknownoption','Vesselness calculation argument unrecognized');
    end
    ...
    if(i==1)
        ...
        if(nargout>2)
            LambdaOut1(Voxel_data>Iout)=Lambda1(Voxel_data>Iout);
            LambdaOut2(Voxel_data>Iout)=Lambda2(Voxel_data>Iout);
            LambdaOut3(Voxel_data>Iout)=Lambda3(Voxel_data>Iout);
            clear Lambda1 Lambda2 Lambda3
