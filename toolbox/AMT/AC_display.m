function h = AC_display(vertex,flag,LineSpec,col)
...
if size(vertex,2) ~= 2 && size(vertex,2) ~= 3
...
elseif nargin == 4
	h = plot(vertex(:,1),vertex(:,2),LineSpec,'Color',col, 'LineWidth', 2);
else
