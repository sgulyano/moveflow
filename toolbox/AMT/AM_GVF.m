function [Fext, energy] = AM_GVF(f, MU, in, normalize)
...
%     energy      the GVF energy i.e. d1-by-d2-by-d3 3D array
% 
...
% 
% This code is modified from Bing Li.
...
%   06-12-2014  return energy as well (by Sarun Gulyanon)
...
%% call faster c routine
    ...
    Fext = AM_GVF_c(single(f), MU, in, 0);
end

energy = get_GVF_energy(f, MU, Fext);
% fprintf('GVF energy: %f\n', sum(energy(:)));
if normalize,
